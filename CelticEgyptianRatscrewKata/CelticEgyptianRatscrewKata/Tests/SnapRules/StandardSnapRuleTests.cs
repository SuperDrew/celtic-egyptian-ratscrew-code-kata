...
namespace CelticEgyptianRatscrewKata.Tests.SnapRules
{
    ...
    public class StandardSnapRuleTests
    {
        ...
        {
            //ACT
            var result = _standardSnapRule.IsSnapValid(new ReadOnlyGameState {Stack = Cards.Empty()});
        ...
        public void ReturnsFalseForAStackWithASingleCard()
        {
            ...
            //ACT
            var result = _standardSnapRule.IsSnapValid(new ReadOnlyGameState {Stack = stack});
